...
def hide_frames():
    ...
    teacher_contact_entry.delete(0, tkinter.END)
    asgn_class_entry.delete(0, tkinter.END)
    student_name_entry.delete(0, tkinter.END)
    parent_contact_entry.delete(0, tkinter.END)
    student_class_entry.delete(0, tkinter.END)
