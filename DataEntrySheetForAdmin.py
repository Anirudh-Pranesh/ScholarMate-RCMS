...
class9=ttk.Checkbutton(root,text='Class 9',onvalue=1,offvalue=0)
class10=ttk.Checkbutton(root,text='Class 10',onvalue=1,offvalue=0)
class11=ttk.Checkbutton(root,text='Class 11',onvalue=1,offvalue=0)
class12=ttk.Checkbutton(root,text='Class 12',onvalue=1,offvalue=0)
#Input Received
